...
// // ANSWER: O(n) because it is iterating through values
...
// // Q: Given an array of numbers, what is the space complexity of this function?
// // ANSWER:O(n) determined by the array
...
// // ANSWER:O(n) because we are iterating through an array
...
// }
// // Q: What is the space complexity of the function?
// // ANSWER:O(n^2)  because the function is calling on itself and 
...
// // ANSWER:O(1) because we are only working with one value
...
// // ANSWER: O(n) because the map operation performs an iteration through the array numbers
...
// }
// // Q: What is the space complexity of this function?
// // ANSWER: O(n^2) because there is a nested loop
...
// // Q: What is the space complexity of this function?
// // ANSWER:O(n) becasue our space will varry depending on the array and grow in a linear pattern


// // Q: Is it possible to improve this function's space complexity? If it is, write a new function below.
// // ANSWER: It cannot get better than o(n) because wewant to perform the function on multiple values of the array
...
// ANSWER: The first function is creating an object to identify each letter a-z and splits a string into it's individual characters, 
//converts them to lwercase so they can all be identified and increses the character count of each letter that matches one in the object.

//the second function converts the string to lowercase to make all characters the same, then uses the regular 
//expression funciton which isolates each character then increases the character ocunt of all characters with
// the same property as it iterates through the string values.
...
console.time('noCacheCalcFac');
console.log(noCacheCalcFac(8))
console.log(noCacheCalcFac(8))
console.log(noCacheCalcFac(8))
console.log(noCacheCalcFac(8))
console.timeEnd('noCacheCalcFac');

console.time('calcFac');
console.log(myFac.calcFac(8))
console.log(myFac.calcFac(8))
console.log(myFac.calcFac(8))
console.log(myFac.calcFac(8))
console.timeEnd('calcFac');
